...
@section('content')
	<div  class="container">
			...
			<form method="POST" action="{{ route('crear_producto_backend') }}" style="margin: 0px;" class="form-horizontal">
		 		@csrf		 		
				    	...
				    	<div class="row">
							...
							<div class="form-group col-md-4">
			 				...
			 				<div class="form-group col-md-4">
								...
								<div class="col-md-12">	
									<input type="text" name="codigo" id="codigo" placeholder="Número serial dispositivo" required="true" class="form-control">
				 				</div>		
			 				</div>
			 				...
			 				<div class="form-group col-md-4">
								...
								<div class="col-md-12">	
									<input type="number" name="precio" id="precio" placeholder="Precio" required="true" class="form-control" onchange="IsNumeric();">
				 				</div>		
			 				</div>
