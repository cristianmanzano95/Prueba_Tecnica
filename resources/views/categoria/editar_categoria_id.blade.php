...
@section('content')
	<div  class="container">
			...
			<form method="POST" action="{{ route('editar_categoria_backend') }}" style="margin: 0px;" class="form-horizontal">
		 		@csrf		 		
		 		<div class="col-md-12" style="margin:15px; background-color: white; border-radius: 15px; border-style: solid; border-width: thin; border-color: lightgray; padding: 15px;">
				  	<div class="col-md-12" >
				    	...
				    	<br>
				    	<div class="row">
				      		<input type="text" name="id" id="id" value="{{$categoria->id}}" class="form-control" hidden="true" style="display: none;">
							<div class="form-group col-md-4 offset-md-4">
								
								<label for="nombre">Nombre</label>
																	
								<div class="col-md-12">	
									<input type="text" name="nombre" id="nombre" placeholder="Nombre del Equipo" required="true" class="form-control" value="{{$categoria->nombre}}">
				 				</div>		
			 				</div>		 				
